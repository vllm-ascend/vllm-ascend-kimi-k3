...
from vllm_ascend.distributed.kv_transfer.kv_pool.ascend_store.config_data import AscendStoreKVConnectorWorkerMetadata, _block_hash_to_bytes
    ...
    def __init__(
        ...
        def process_request():
            while self.running:
                ...
                block_hashes = [
                    BlockHash(_block_hash_to_bytes(h))
                    for h in hashes_str
                ]
